...
**בתחילת כל סשן**, קרא את `logs/chat.log` (אם קיים) כדי לראות את השיחות האחרונות מטלגרם.
**אחרי כל שיחת טלגרם שהמשתמש מזכיר** — קרא את `logs/chat.log` אוטומטית ונתח את השיחה בלי שהמשתמש יצטרך להעתיק אותה.
אם הקובץ לא קיים, דלג בשקט.
