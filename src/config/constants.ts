...
export const VALID_TRANSITIONS: Record<string, string[]> = {
  ...
  PENDING_PARTNER_CONSENT: ['REFLECTION_GATE', 'PARTNER_DECLINED', 'CLOSED', 'LOCKED'],
  REFLECTION_GATE: ['ACTIVE', 'LOCKED', 'CLOSED'],
  ACTIVE: ['PAUSED', 'CLOSED', 'LOCKED'],
  ASYNC_COACHING: ['INVITE_CRAFTING', 'INVITE_PENDING', 'ACTIVE', 'CLOSED', 'LOCKED'],
  PAUSED: ['ACTIVE', 'CLOSED', 'LOCKED'],
  CLOSED: ['LOCKED'],
  LOCKED: [], // terminal
